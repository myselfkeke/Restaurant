...
<body>
  ...
  include "header.php";
  ?>
    <!-- code for main hero section starts here -->
     <div class="container">
    <div class="container-left">
      <h1>
        <span style="color: orange;" >Let's</span>
        <span style="color: grey;">Eat </span>
        <span style="color: #02a237;">together</span>
      </h1>
      <p>The Best Restaurant</p>
      <br>
      <br>
      <button style="background-color: orange;">View More</button>
      <button style="background-color: #02a237;">Order Now</button>
      <br>
      <img src="./images/eating.png" alt="eating">
    </div>
    <div class="container-right">
      <img src="./images/hero.png" alt="hero-rotating-food">
    </div>
  </div>

    <!-- code for main hero section ends here -->
   
  <!-- code for why choose us starts here... -->
   <br>
  <h2 class="featured-heading">Why Choose Us ?</h2>
  <hr>
  <centre>
      ...
      <div class="featured-outer">
        ...
        <div class="featured-icon">
          ...
          <br>
          <span class="icon-title">Fresh Food</span>
        </div>
        
        <div class="featured-icon">
          <i class="fa fa-clock-o" aria-hidden="true"></i>
          <br>
          <span class="icon-title">24 * 7</span>
        </div>
        
        <div class="featured-icon">
          <i class="fa fa-motorcycle" aria-hidden="true"></i>
          <br>
          <span class="icon-title">Fast Delivery</span>
        </div>
     
        <div class="featured-icon">
          <i class="fa fa-birthday-cake" aria-hidden="true"></i>
          <br>
          <span class="icon-title">Birthday Space</span>
        </div>
        
        <div class="featured-icon">
          <i class="fa fa-star" aria-hidden="true"></i>
          <br>
          <span class="icon-title">260+ Reviews</span>
        </div>
      </div>
    </centre>
    <!-- code for why choose us ends here... -->
    <!-- code for featured food item dynamic gallery starts here... -->
     <br>
     
     <br>
    <h2 class="featured-heading">Featured Food Items</h2>
    <hr>

    <div class="featured-gallery-outer">
      <div class="featured-img">
        <img src="./images/dosa1.jpg" alt="Cake Image">
      </div>
      <div class="featured-img">
        <img src="./images/pav bhaji1.jpg" alt="Cake Image">
      </div>
      <div class="featured-img">
        <img src="./images/samosa4.jpg" alt="Cake Image">
      </div>
      <div class="featured-img">
        <img src="./images/poha1.jpg" alt="Cake Image">
      </div>
      <div class="featured-img">
        <img src="./images/pizza1.jpg" alt="Cake Image">
      </div>
      <div class="featured-img">
        <img src="./images/dosa2.jpg" alt="Cake Image">
      </div>
      <div class="featured-img">
        <img src="./images/pasta1.jpeg" alt="Cake Image">
      </div>
      <div class="featured-img">
        <img src="./images/ice cream 1.jpg" alt="Cake Image">
      </div>
      
      <div class="featured-img">
        <img src="./images/cake9.jpg" alt="Cake Image">
      </div>
    </div>
    <!-- code for featured food item dynamic gallery ends here... -->
    <!-- code for our speciality section starts here... -->
     
     <br>
    <h2 class="featured-heading">Our speciality</h2>
    <hr>
    <div class="speciality-container">
      <div class="phamplet1">
        <img src="./images/dosa3.jpeg" alt="">
      ...
      <div class="phamplet2">
        ...
        <img src="./images/samosa3.jpg" alt="">
      </div>
      <div class="phamplet3">
