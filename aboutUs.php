...
<body>
  ...
  ?>
    ...
    <div class="container-left">
      ...
      <br>
      <br>
      <button style="background-color: #02a237; width: 170px;">Download Brochure</button>
      <br>
      <img src="./images/eating.png" alt="eating">
    </div>
    <div class="container-right-about-us-chef2">
      <img src="./images/chef2.png" alt="hero-rotating-food">
    </div>
  </div>

    <!-- code for about us hero section ends here -->
         
   
   <br>
  <h2 class="featured-heading">Our Team Members</h2>
  <hr>
  
  <centre>
    
      <div class="featured-outer-aboutus">
        
        <div class="featured-img">
          <img src="./images/person6.png" alt="Team Member">
        </div>
        
        <div class="featured-img">
          <img src="./images/person3.png" alt="Team Member">
        </div>
        
        <div class="featured-img">
          <img src="./images/person10.png" alt="Team Member">
        </div>
        ...
        <div class="featured-img">
          <img src="./images/person5.png" alt="Team Member">
        </div>
        
        <div class="featured-img">
          <img src="./images/person4.png" alt="Team Member">
        </div>

        <div class="featured-img">
          <img src="./images/person7.png" alt="Team Member">
        </div>
        
        <div class="featured-img">
          <img src="./images/person8.png" alt="Team Member">
        </div>
        
      </div>
    </centre>
    <!-- code for Out team members ends here... -->
